<div x-data="{ open: @entangle('open') }">
    <!-- Overlay -->
    <div x-show="open" x-cloak class="fixed inset-0 bg-black opacity-60 z-40"></div>
        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-neutral-primary-soft border border-default rounded-base shadow-sm p-4 md:p-6">
                ...
                <div class="space-y-3 py-3">
                    ...
                    {{-- Dropdown pelanggan --}}
                    <div>
                        <label class="block mb-2.5 text-sm font-medium text-heading">Pilih Pelanggan</label>
                ...
                <div class="flex items-center justify-end border-t border-default pt-4 space-x-3">
                    ...
                    <button wire:click="cetak" class="text-white bg-brand hover:bg-brand-strong px-4 py-2 rounded-base text-sm font-medium">
                        Cetak Nota
                    </button>
