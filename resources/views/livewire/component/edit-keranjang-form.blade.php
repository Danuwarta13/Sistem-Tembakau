            ...
            <div class="relative bg-neutral-primary-soft border border-default rounded-base shadow-sm flex flex-col max-h-[90vh] p-3 sm:p-4 md:p-6">
                ...
                <form wire:submit.prevent="update" action="#" class="flex flex-col flex-1 overflow-hidden ">
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-4 border-t border-default pt-3 shrink-0">
                        {{-- Update --}}
                        <button type="submit" class="w-full sm:w-auto text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                            Update product
                        </button>
                        ...
                        <div class="fixed inset-0 flex items-center justify-center z-50">
                            <div class="bg-white p-6 rounded-lg w-80 shadow-lg">
                                ...
                                <div class="mt-4 flex justify-end gap-2">
                                    <button type="button" wire:click="$set('showDeleteModal', false)" class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400">
                                        Batal
                                    </button>
