<div wire:poll.2500ms
    class=" p-6 mb-5 relative bg-neutral-primary-soft rounded-base border border-dashed border-default shadow-xl">

    {{-- Title --}}
    <div class=" text-center ">
        <h1 class=" text-lg font-bold tracking-tight text-heading md:text-lg lg:text-2xl">Data Keranjang</h1>
        <p class=" text-sm font-normal text-body lg:text-sm sm:px-16 xl:px-48">Here at Flowbite we focus on markets
            where technology.</p>
    </div>
    ...
    <div class="p-2 flex items-center justify-between">
        <form wire:submit.prevent="search" action="">
            ...
            <div class="relative">
                ...
                <input wire:model.live.debounce.250ms="query" type="search" id="input-group-1"
        ...
        <button wire:click="$dispatch('open-cetak-nota-modal')"
            class="inline-flex items-center justify-center text-white bg-green-600 hover:bg-green-500 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-base text-sm ms-1.5 px-1.5 py-2 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
            type="button">
            <svg class=" hidden sm:block w-5 h-5 me-1 -ms-0.5 dark:text-white" aria-hidden="true"
                    ...
                    <tr class="bg-neutral-primary-soft border-b border-default hover:bg-neutral-secondary-medium">
                        ...
                        <td class="px-6 py-4">
                            <button wire:click="edit({{ $barang->id }})"
                                class="block text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-300"
                                type="button">
                                Edit
                            </button>
                        </td>
